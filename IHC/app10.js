...
function hacerVisibleCarrito(){
    ...
    var items =document.getElementsByClassName('platillos')[0];
...
function guardarCarritoEnLocalStorage() {
    ...
    // Recorremos el carrito y almacenamos los datos en un arreglo
    ...
    // Guardamos el arreglo de items en localStorage
